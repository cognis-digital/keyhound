#!/usr/bin/env sh
# Universal installer for keyhound. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/keyhound.git"
echo "Installing keyhound ..."
